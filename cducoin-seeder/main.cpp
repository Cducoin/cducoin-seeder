...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Cducoin-seeder\n"
...
static const string mainnet_seeds[] = {"127.0.0.1", "dnsseed.cyberminingpool.com", "dnsseed.cdublockchain.com", "seed.olympusminingpool.com", ""};
static const string testnet_seeds[] = {"testnet-seed.",
                                       "testnet-seed.",
                                       "testnet-seed.",
                                       "testnet-seed.",
                                       ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("dnsseed.cyberminingpool.com", GetDefaultPort()), true);
  }
  do {
